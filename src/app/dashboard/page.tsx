          ...
          <Card>
            ...
            <CardContent className="space-y-2">
              ...
              {(user?.role === UserRole.HOSPITAL_ADMIN || user?.role === UserRole.SUPER_ADMIN) && (
                <Link href="/doctors/new" className="block p-3 rounded-md bg-blue-50 hover:bg-blue-100 transition-colors">
                  <div className="font-medium text-blue-900">Add New Doctor</div>
                  <div className="text-sm text-blue-600">Register a new doctor to hospital</div>
                </Link>
              )}
              <Link
                href="/patients/new"
