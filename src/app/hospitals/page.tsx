      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {hospitals.map((hospital) => (
            <Card key={hospital._id} className="card-hover">
              <CardHeader>
                ...
                <CardDescription>
                  <div className="space-y-1">
                    ...
                    <div className="text-sm text-slate-500">
                      <span className="font-medium">Established:</span> {hospital.establishedYear}
                    </div>
                    <div className="text-sm text-slate-500">
                      <span className="font-medium">Bed Capacity:</span> {hospital.bedCapacity}
                    </div>
                  </div>
                </CardDescription>
              </CardHeader>
